      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-slate-800/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-slate-700/50 p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Spy Agency</h1>
            <p className="text-slate-400">Classified Access Portal</p>
          </div>
          ...
          <div className="mt-6 text-center">
            ...
            >
              New recruit? <span className="text-red-500 font-semibold">Register here</span>
            </button>
          </div>
        </div>

        <div className="text-center mt-4 text-slate-600 text-xs">
          <p>CLASSIFIED LEVEL 5 • AUTHORIZED PERSONNEL ONLY</p>
        </div>
      </div>
    </div>
  );
