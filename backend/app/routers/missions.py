...
def create_mission(
    ...
    assigned_user_ids: list[int] = Body(...),
    ...
    """
    created_mission = missions_service.create_mission(cursor, content=mission_data.content, creator_id=current_user.id, assigned_user_ids=assigned_user_ids)
